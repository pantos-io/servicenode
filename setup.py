...
setuptools.setup(
    ...
    package_data={
        'pantos': ['service-node-config.yml', 'service-node-config.env', 'alembic.ini', 'bids.yml'],
        ...
        'psycopg2-binary==2.9.6', 'PyYAML==6.0.1', 'SQLAlchemy==2.0.18', 'web3==6.5.0',
        'JSON-log-formatter==0.5.2', 'pyaml-env==1.2.1', 'python-dotenv==1.0.1'
    ],
